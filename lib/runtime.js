...
function jsfun(f) {
  return function(n) {return jsf(eval(_tostr(f)), n(), []);};
}
...
function js2ls(x) {
  if(x instanceof Array || x.charAt) {
...
function _exp(f) {
  if(f.arity == 0) {
    return function() {return ls2js(f);};
  }
  return function() {
      var res = f;
      for(var i = 0; i < arguments.length; ++i) {
        var a = arguments[i];
        res = res(function() {return js2ls(a);});
      }
      return ls2js(function() {return res;});
    };
}

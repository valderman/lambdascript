...
function $jsfun(f) {
  ...
  return [-1, function() {return _js2ls(f.apply(null, a))();}];
}

function _jsf(f, n, as) {
  if(as.length == n) {
    return [-1, function() {return _js2ls(f.apply(null, as))();}];
  }
  return function(x) {
      as.push(_ls2js(x));
      return _jsf(f, n, as);
...
function $conc(a, b) {
  if(a()[0]) {
    return [1, a()[1], function _(){if($u===_.x) _.x=$conc(a()[2], b);return _.x;}];
  }
  return b();
}
...
function $writeIORef(ref) {
    return function(x) {ref().val = x; return [-1,function() {return [0];}];};
}
...
function $bind(m) {
  return function(f) {
      return [-1, function() {
        m = _t(m, [])[1]();
        return _t(f(), [function() {return m;}])[1]();
      }];
  }
}
